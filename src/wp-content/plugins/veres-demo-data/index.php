<?php
/*
Plugin Name:    Veres Package Demo Data
...
class Veres_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'veres';

    public static $demo_site = 'https://veres.la-studioweb.com/';
...
add_action('plugins_loaded', function(){
    ...
    if(strpos(strtolower($theme->get_template()), 'veres') === false){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Veres Package Demo Data" requires %3$s"Veres"%4$s theme to be installed and activated. Please active %3$s"Veres"%4$s to continue.%2$s', 'lastudio-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Veres_Data_Demo_Plugin_Class::get_instance();
}, 999);