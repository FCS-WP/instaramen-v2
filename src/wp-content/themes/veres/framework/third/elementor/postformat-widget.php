...
if(!class_exists('Veres_Elementor_PostFormat_Content_Widget')){

	class Veres_Elementor_PostFormat_Content_Widget extends \Elementor\Widget_Base{
		...
		public function get_title() {
			return esc_html__('LaStudioKit PostFormat Content', 'veres');
		}
		...
		protected function register_controls() {
			...
			$this->start_controls_section(
				'section_content',
				[
					'label' => esc_html__( 'Settings', 'veres' ),
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'options' => [
						...
						'center' => [
							'title' => __( 'Center', 'veres' ),
							'icon' => 'eicon-text-align-center',
						],
						'right' => [
							'title' => __( 'Right', 'veres' ),
							'icon' => 'eicon-text-align-right',
						],
						'justify' => [
							'title' => __( 'Justified', 'veres' ),
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Image/Gallery', 'veres' ),
			...
			$this->add_control(
				'custom_height',
				array(
					'label'        => esc_html__( 'Enable Custom Image Height', 'veres' ),
			...
			$this->add_responsive_control(
				'height',
				array(
					'label' => esc_html__( 'Image Height', 'veres' ),
					'type'  => \Elementor\Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => 100,
			...
			$this->add_control(
				'quote_bg_color',
				array(
					'label' => esc_html__( 'Background Color', 'veres' ),
			...
			$this->add_control(
				'quote_text_color',
				array(
					'label' => esc_html__( 'Text Color', 'veres' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => array(
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Quote Typography', 'veres' ),
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Cite Typography', 'veres' ),
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Link Typography', 'veres' ),
			...
			$this->add_responsive_control(
				'link_padding',
				array(
					'label'       => esc_html__( 'Padding', 'veres' ),
		...
		protected function render() {
			...
			echo veres_get_post_thumbnail_format( $image_size );
		}
